...
public interface Location {
     ...
     *
     * @param host Specifies the hostname and port number of the URL
     */
    @JsProperty
     ...
     * The hostname property sets the hostname of a URL.
     *
     * @param hostname Specifies the hostname of the URL
     */
    @JsProperty
     ...
     *
     * @param href Specifies the URL of the link.<br>
     *            Possible values:<br>
     *            <ul>
     ...
     *
     * @param pathname Specifies the pathname of the URL
     */
    @JsProperty
     ...
     *
     * @param port Specifies the port number of the URL
     */
    @JsProperty
     ...
     *
     * @param protocol The protocol of the URL. Possible values:
     *            <ul>
     *            <li>file:
     *            <li>http:
     *            <li>https:
     ...
     *
     * @param search Specifies the search part of the URL
     */
    @JsProperty
     ...
     * page from the server by setting the forceGet parameter to true: location.reload(true).
     *
     * @param forceGet Optional. Specifies the type of reloading:<br>
