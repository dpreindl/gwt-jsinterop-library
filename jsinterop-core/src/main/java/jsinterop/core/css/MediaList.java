...
public interface MediaList {
    ...
    /**
     * @param mediaText The parsable textual representation of the media list.
     */
    @JsProperty
     ...
     *
     * @param newMedium The medium to add to the end of the list
     */
    @JsMethod
     ...
     *
     * @param index The index to get the medium for
